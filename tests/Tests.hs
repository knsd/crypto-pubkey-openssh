...
tests = testGroup "Crypto.PubKey.OpenSsh.Tests"
    [ testCase "Test DSA wrong" $ testKey dsaDefaultWrong
    , testCase "Test DSA correct" $ testKey dsaDefaultCorrect
